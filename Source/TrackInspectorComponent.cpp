...
//==============================================================================
TrackInspectorComponent::TrackInspectorComponent()
{
...
void TrackInspectorComponent::paint (Graphics& g)
{
    ...
    */
    ...
    g.setFont (24.0f);
    g.drawText ("TrackInspectorComponent", getLocalBounds(),
